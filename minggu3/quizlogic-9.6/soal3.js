...
- Function menerima array yang berisikan object pembeli
- Jika stock barang kurang dari jumlah yang ingin dibeli, maka pembeli batal membeli barang.
- mengembalikan/me-return sebuah array of object
...
function countProfit(shoppers) {
    ...
    if (shoppers.length === 0) { //Kalo gada shopper langsung balikin aja
        return shoppers;
    }

    let result = [] //simpen obj

    for (let i = 0; i < listBarang.length; i++) { //buat obj yang nyimpen sesuai ketentuan output
        let obj = {
        ...
        for (let j = 0; j < shoppers.length; j++) { //Nyari shopper dan total propit

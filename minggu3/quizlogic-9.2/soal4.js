...
function cariModus(arr) {
    ...
    if (num[0] === undefined || isTrue && num[0] == num[num.length-1]) {
        return -1
    } else {
        return num[0]
    }

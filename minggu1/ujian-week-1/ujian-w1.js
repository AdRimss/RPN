...
function balikKata1(kata) {
    const reversed = Array.from(kata).reverse().join('') //Mengambil Array Masing Masing Huruf dari param, Lalu Reverse, lalu digabungkan dengan 'spasi'
    return reversed
}

// TEST CASES
console.log(balikKata1('Hello World and Coders')); // sredoC dna dlroW olleH
